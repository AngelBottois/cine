                        ...
                        <div class="nk-header-wrap">
                            <div class="nk-header-brand">
                                <a href="html/index.html" class="logo-link">
                                    <img class="logo-light logo-img" src="./angel/cine/utiles/img/front/logo.svg" alt="logo">                                </a>
                            </div><!-- .nk-header-brand -->
                            <div class="nk-header-menu">
                                <ul class="nk-menu nk-menu-main">
                                    <li class="nk-menu-item">
                                        <a href="angel/cine/index.php?ctl=inicio" class="nk-menu-link">
                            ...
                            <div class="nk-header-tools">
                                <ul class="nk-quick-nav">
                                    <li>
                                        <p><a href="angel/cine/index.php?ctl=logout">Cerrar Sesión</a></p>
                                    </li>
