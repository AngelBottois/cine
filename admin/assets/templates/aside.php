                                ...
                                <div class="nk-sidebar-menu" data-simplebar>
                                    ...
                                    <ul class="nk-menu">
                                        <li class="nk-menu-heading">
                                            <h6 class="overline-title text-primary-alt">Opciones</h6>
                                        </li><!-- .nk-menu-heading -->
                                        <li class="nk-menu-item has-sub">
                                            <a href="angel/cine/index.php?ctl=listadoP" class="nk-menu-link nk-menu-toggle">
                                        ...
                                        <li class="nk-menu-item has-sub">
                                            <a href="angel/cine/index.php?ctl=listadoA" class="nk-menu-link nk-menu-toggle">
                                                <span class="nk-menu-icon"><em class="icon ni ni-users"></em></span>
                                                <span class="nk-menu-text">Actores</span>
                                            </a>
                                            <ul class="nk-menu-sub">
                                                <li class="nk-menu-item">
                                        ...
                                        <li class="nk-menu-item has-sub">
                                            <a href="angel/cine/index.php?ctl=listadoU" class="nk-menu-link nk-menu-toggle">
                                        ...
                                        <li class="nk-menu-item has-sub">
                                            <a href="angel/cine/index.php?ctl=listadoS" class="nk-menu-link nk-menu-toggle">
