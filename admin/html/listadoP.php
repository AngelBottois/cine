                                    ...
                                    <div class="components-preview wide-md mx-auto">
                                        <div class="nk-block-head nk-block-head-lg wide-sm">
                                            <div class="nk-block-head-content">
                                                ...
                                                <h2 class="nk-block-title fw-normal">Peliculas disponibles</h2>
                                                <div class="nk-block-des">
                                                    <!-- Meter  -->
                                                    <p class="lead"><a href="/angel/cine/index.php?ctl=addPelicula">Añadir pelicula</a></p>                                                
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head -->
                                                    ...
                                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                        <thead>
                                                            <tr class="nk-tb-item nk-tb-head">
                                                                ...
                                                                <th class="nk-tb-col"><span class="sub-text">Portada</span></th>
                                                                ...
                                                                <th class="nk-tb-col tb-col-xl"><span class="sub-text">Clasificación</span></th>
                                                                <th class="nk-tb-col tb-col-xl"><span class="sub-text">Género</span></th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="nk-tb-item">
                                                                ...
                                                                <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                                    <span class="tb-amount"><?= $pelicula['nombre'] ?></span>
                                                                </td>
                                                                <td class="nk-tb-col tb-col-md">
                                                                    <span><?= $pelicula['argumento'] ?></span>
                                                                </td>
                                                                <td class="nk-tb-col tb-col-xl" data-order="Email Verified - Kyc Unverified">
                                                                    <ul class="list-status">
                                                                        <li><em class="icon text-success ni ni-check-circle"></em> <span><?= $pelicula['clasificacion_edad'] ?></span></li>
                                                                    </ul>
                                                                </td>
                                                                <td class="nk-tb-col tb-col-xl">
                                                                    <span><?= $pelicula['genero_id'] ?></span>
                                                                </td>
                                                                <!-- <td class="nk-tb-col tb-col-md">
