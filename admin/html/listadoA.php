                                    ...
                                    <div class="components-preview wide-md mx-auto">
                                        <div class="nk-block-head nk-block-head-lg wide-sm">
                                            <div class="nk-block-head-content">
                                                ...
                                                <h2 class="nk-block-title fw-normal">Personal disponible</h2>
                                                <div class="nk-block-des">
                                                    <!-- Meter  -->
                                                    <p class="lead"><a href="/angel/cine/index.php?ctl=addActor">Añadir integrante</a></p>                                               
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head -->
                                                    ...
                                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                        <thead>
                                                            <tr class="nk-tb-item nk-tb-head">
                                                                ...
                                                                <th class="nk-tb-col"><span class="sub-text">Foto</span></th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="nk-tb-item">
                                                                ...
                                                                <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                                    <span class="tb-amount"><?= $actor['nombre'] ?></span>
                                                                </td>
                                                    ...
                                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="nk-tb-item">
                                                                ...
                                                                <td class="nk-tb-col tb-col-mb" data-order="35040.34">
                                                                    <span class="tb-amount"><?= $director['nombre'] ?></span>
                                                                </td>
                                                                <!-- <td class="nk-tb-col tb-col-md">
                                                                    <span class="tb-status text-success">Active</span>
                                                                </td> -->
